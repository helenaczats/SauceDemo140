...
class TestSelecionarProduto():
  def setup_method(self, method):
    ...
    self.vars = {}
    self.driver.implicitly_wait(5) #irá esperar por qualquer elemento por até 5 segundos
  ...
  def test_selecionarProduto(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"title\"]").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"item-quantity\"]").click()
    assert self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"inventory-item-name\"]").text == "Sauce Labs Backpack"
    assert self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"inventory-item-price\"]").text == "$29.99"
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"remove-sauce-labs-backpack\"]").click()
    self.driver.find_element(By.ID, "react-burger-menu-btn").click()
    #time.sleep(100) #parando o processamento / thread por 2 segundos para dar tempo de abrir o menu/seu uso é temporário(alfinete roupa)
